 ...
 *
 */
this.ckan.module('modal-report', function (jQuery, _) {
  ...
  return {
    ...
    options: {
      template: '/api/1/util/snippet/report_form.html',
      i18n: {
        noTemplate: _('Sorry, we could not load the report form. Please try again later.'),
        loadError: _('Sorry, we could not load the report form. Please try again later.'),
